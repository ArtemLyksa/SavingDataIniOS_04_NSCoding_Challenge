...
class OTRShow: NSObject, NSCoding {
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        guard let title = aDecoder.decodeObjectForKey("showTitle") as? String, fileName = aDecoder.decodeObjectForKey("showFileName") as? String, showDescription = aDecoder.decodeObjectForKey("showDescription") as? String else {
            return nil
        }
